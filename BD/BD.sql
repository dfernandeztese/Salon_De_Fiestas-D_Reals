...
insert into Salones values('Salon CD. Azteca', 100, 250, 'CD. Azteca')
...
insert into Cliente values ('Mar�a', 'Gonz�lez', 'P�rez', '5512345678', '5678@gmail.com')
insert into Cliente values ('Juan', 'Hern�ndez', 'Ram�rez', '5598765432', '5432@hotmail.com')
insert into Cliente values ('Ana', 'Mart�nez', 'L�pez', '5534567890', '7890@yahoo.com')
insert into Cliente values ('Carlos', 'S�nchez', 'Torres', '5543216789', '6789@outlook.com')
...
insert into Tipo_eventos values('xv a�os')
...
insert into Entradas values('crema de champi�ones')
...
insert into Medios values('spaguetti poblano')
...
insert into Fuertes values('lomo de cerdo en hierbas finas')
...
insert into Eventos values ('2024-06-15', '18:00', '23:00', 200, (select ID_tipoE from Tipo_eventos where nombre = 'xv a�os'), (select ID_menu from Comida where ID_menu = 1))
...
insert into Contratos values ((select ID_cliente from Cliente where nombre = 'Juan' and apellido_p = 'Hern�ndez' and apellido_m = 'Ram�rez'), (select ID_evento from Eventos where fecha = '2024-07-20' and hora_ini = '12:00'))
insert into Contratos values ((select ID_cliente from Cliente where nombre = 'Ana' and apellido_p = 'Mart�nez' and apellido_m = 'L�pez'), (select ID_evento from Eventos where fecha = '2024-09-05' and hora_ini = '10:00'))
insert into Contratos values ((select ID_cliente from Cliente where nombre = 'Carlos' and apellido_p = 'S�nchez' and apellido_m = 'Torres'), (select ID_evento from Eventos where fecha = '2024-05-30' and hora_ini = '14:00'))
